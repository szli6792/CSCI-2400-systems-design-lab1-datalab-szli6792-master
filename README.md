...
Score = 64/64 [36/36 Corr + 28/28 Perf] (120 total operators)
```
Two of these problems (`float_neg` and `float_twice`) are optional extra credit problems; thus a perfect score on the required problems is a score of `36/36 Corr + 28/28 Perf`.
